...
using AguiarMovies.Views;
using System;
using System.Collections.Generic;
using System.Threading.Tasks;
using Xamarin.Forms;

namespace AguiarMovies.Services.Navigation
{
    public class NavigationService : INavigationService
    {
        ...
        protected Type GetPageTypeForViewModel(Type viewModelType)
        {
            ...
            {
                throw new KeyNotFoundException($"Mapeamento para ${viewModelType} não foi encontrado nas configurações de mapeamento");
            }
        ...
        protected Page CreateAndBindPage(Type viewModelType, object parameter)
        {
            ...
            if (pageType == null)
            {
                throw new Exception($"Tipo de mapeamento para {viewModelType} não é uma page");
            }
